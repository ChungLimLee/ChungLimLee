...
### 🎮 [SO Othello – Unlimited Endgame Generator/Solver](https://github.com/ChungLimLee/soOthello)
A fully interactive Othello app in JS with unlimited endgame generator/solver, study mode, puzzle sharing via link, and AI-powered interactive play.
